...
const Main = () => {
  ...
  return (
    <div className="flex flex-col px-12 pt-5 flex-1 grow h-full overflow-hidden">
      {/*  */}
      ...
      >
        <div className="py-5 grid grid-cols-3 gap-x-4 overflow-hidden">
          {/* To Do */}
          <Droppable droppableId="todo">
            {(provided) => (
              <div
                className="bg-green-500 overflow-hidden flex flex-col rounded-2xl row-span-1 px-5"
